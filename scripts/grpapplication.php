...
if(isset($_POST["name1"]) && isset($_POST["nickname1"]) && isset($_POST["name2"]) && isset($_POST["nickname2"]) && isset($_POST["name3"]) && isset($_POST["nickname3"]) && isset($_POST["name4"]) && isset($_POST["nickname4"]) && isset($_POST["name5"]) && isset($_POST["nickname5"]) && isset($_POST["birthday"]) && isset($_POST["number"]) && isset($_POST["email"]) && isset($_POST["school"]) && isset($_POST["yr"]) && isset($_POST["crs"]) && isset($_POST["org"]) && isset($_POST["greencomputing"]) && isset($_POST["greenindustry"])) {
  // form data is complete
  $email_from = $_POST["email"];
  $name       = $_POST["name1"];
  $message = "IMConference 2015: Individual Application Form\n";
  $message = $message + "\nMember 1 Name: " + $name1;
  $message = $message + "\nMember 1 Nickname: " + $_POST["nickname1"];
  $message = $message + "\nMember 2 Name: " + $name2;
  $message = $message + "\nMember 2 Nickname: " + $_POST["nickname2"];
  $message = $message + "\nMember 3 Name: " + $name3;
  $message = $message + "\nMember 3 Nickname: " + $_POST["nickname3"];
  $message = $message + "\nMember 4 Name: " + $name4;
  $message = $message + "\nMember 4 Nickname: " + $_POST["nickname4"];
  $message = $message + "\nMember 5 Name: " + $name5;
  $message = $message + "\nMember 5 Nickname: " + $_POST["nickname5"];
  ...
  $isValidName     = preg_match("/^.*\S.*$/", $name1);
